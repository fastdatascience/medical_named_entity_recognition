with open("src/medical_named_entity_recognition/__init__.py", "r", encoding="utf-8") as f:
    text = f.read()
...
with open("src/medical_named_entity_recognition/__init__.py", "w", encoding="utf-8") as f:
    f.write("\n".join(init_py_lines))
